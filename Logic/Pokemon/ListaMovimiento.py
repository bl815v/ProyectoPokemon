...
hidropulso = Movimiento("Hidropulso", 60, 100, 2, "Agua")
torbellino = Movimiento("Torbellino", 35, 85, 3, "Agua")
placaje = Movimiento("Torbellino", 40, 100, 4, "Normal")
surf = Movimiento("surf", 90, 100, 1, "Agua")
