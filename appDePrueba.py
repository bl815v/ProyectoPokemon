...
print(DiccionarioPokemon().DiccionarioDePokemon('Pikachu', 'Nombre'))   #Escribe el nombre del pokemon y el tipo de estadistica que necesita- si son todas 'Todo'
...
print(ListaMovimiento().EstadisticasMovimientos('Pikachu', 1,'Nombre'))   #Esta seria la ideal para usar, escribe el nombre del pokemon que necesita, el numero del ataque (1-4), y 
